...
export default {
	...
	leavedRoom: 'Left the Room',
	roomDissolved: 'Room Has Been Dissolve. Pay Attention to Save the Archive',
	connectLose: 'Server Connect Failed, Pay Attention to Save the Archive',
